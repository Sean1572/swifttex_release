...
function compileLaTeXRoutine() {
    ...
    if (status === 0) {
        ...
        self.postMessage({ result: "ok", status: status, log: self.memlog, pdf: pdfArrayBuffer.buffer, cmd: "compile" }, [pdfArrayBuffer.buffer]);
    } else {
...
var wasmBinaryFile;
wasmBinaryFile = "https://github.com/Sean1572/swifttex_release/raw/main/swiftlatex/swiftlatexpdftex.wasm";
